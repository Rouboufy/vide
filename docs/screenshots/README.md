...
These WebP images come from the real Vide executable built from this checkout.
...
Use `--data-dir /path/to/vide-data` to capture a separate installation.

The script opens Vide in isolated temporary XDG directories, with a demo Git
repository containing copies of Vide source files. It uses the default VS Code
