...
thread. Disable/rollback reverts `7098b0a`, `e9d900f`, and the `079b856`
acceptance record, plus only the reactor portions of mixed commits `098ed75` and
`a9c83a2`; it does not remove their 04A documentation or require reverting
Prompt 03.
