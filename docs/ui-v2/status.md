...
| 01B Low-fidelity prototypes | Proposed; UX approval required | Prompt 01A implementation `137d8a8` and accepted 2026-08-25 | uncommitted working tree | `docs/ui-v2/prototype-contract-01b.md`; `docs/ui-v2/transitions-01b.md`; `docs/ui-v2/prototypes-01b/*.txt`; `docs/ui-v2/prototypes-01b/states/*.txt`; `docs/ui-v2/prototypes-01b/boundaries/*.txt`; `docs/ui-v2/generate_01b.py`; `docs/ui-v2/prototype_harness_01b.py`; `docs/ui-v2/verify_01b.py`; `python3 docs/ui-v2/generate_01b.py`; `python3 docs/ui-v2/verify_01b.py`; `python3 docs/ui-v2/verify_01a.py`; `git diff --check`; runtime tests not applicable because no runtime behavior changes | Proposed 2026-08-25; expert blockers corrected with deterministic state, transition, and boundary decks; no design selected and no participant/external validation claimed; follow-up: Prompt 01C evaluates all alternatives with the fixed script | no persisted-state impact; rollback by removing only the 01B document, transition evidence, harness, generator, verifier, generated assets, and this row; no feature flag, compatibility seam, or partial rollout |
