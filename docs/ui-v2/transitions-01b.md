...
| T11 | `focus-navigation` -- `mode.zen` -- `zen` -- Leave Zen -- `focus-navigation` | save Navigation owner/selection; Zen makes Editor sole owner; restore Navigation |
...
| T21/22 | `focus-navigation` -- delete key/click / Explorer delete -- `delete-confirmation` -- Cancel -- `focus-navigation` | push Navigation; Delete dialog owns focus; cancel restores Navigation and tree |
